      ...
      <div className={modalcardStyles.container}>
        ...
        <div className={modalcardStyles.info}>
          ...
          <p className={modalcardStyles.description}>
            ...
            aliquet urna at purus ullamcorper, non iaculis diam sagittis. Nulla
            mi orci, feugiat eu vulputate id, dignissim sed ex. Integer cursus
            luctus odio ut condimentum. Integer ullamcorper sed ipsum id
            commodo. Morbi iaculis risus ac diam dictum hendrerit. Fusce
            suscipit risus sem, a porttitor libero venenatis ut. Integer
            vehicula, nulla tincidunt laoreet varius, sem elit laoreet sem, eget
            pretium ante dui ut magna.
          </p>
          ...
          <div className={modalcardStyles.buttons}>
            <button
              className={modalcardStyles.button__order}
              onClick={() => onClose()}
            >
              Заказать
            </button>
            <button className={modalcardStyles.button__like}>
              <Icons name="like" size="40" color="#e457ad" />
            </button>
          </div>
        </div>

        <button
          className={modalcardStyles.button__close}
          onClick={() => onClose()}
        >
          <Icons
            className={modalcardStyles.icon}
            name="cross"
            size="28"
            color="gray"
          />
