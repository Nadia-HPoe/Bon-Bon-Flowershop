        ...
        <div className={styles.header__container}>
          ...
          <div className={styles.header__rightContainer}>
            <div className={styles.header__search}>
              <Icons name="magnifying-glass" size="24" color="#042423" />
            ...
            <div className={styles.header__phone}>
              ...
              <a href="https://wa.me/message/CGNNUIQSEJQYB1">
                <Icons name="phone" size="34" color="#023E3B" />
              </a>
            </div>
            <div className={styles.header__icons}>
              <button href="#" className={styles.header__icon}>
                <Icons name="user" size="28" color="#727272" />
              </button>
              <a href="#" className={styles.header__icon}>
                <Icons className={styles.header__heart} name="heart" size="22" color="#EBEBEB" />
              </a>
