    ...
    <footer className={styles.footer}>
      <div className={styles.footer__text__block}>
        <p className={styles.footer__text}>
          Мы уверены, что атмосфера уюта и искреннего отношения к каждому гостю — главный секрет
          успеха BonFlower.
        </p>
        <p className={styles.footer__text}>
          Для нас важно, чтобы каждый клиент уходил с улыбкой и желанием вернуться вновь!
        </p>
      </div>
